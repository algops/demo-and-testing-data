...
The naming conventions for Issue titles should mirror those of Git commit messages and must adhere to the rules of Conventional Commits. Please [refer to the ✉️ Commit Messages section](./Git%20Strategy.md#h-%E2%9C%89%EF%B8%8F-commit-messages) in the Git Strategy document.
...
2. When the production Deployment concludes successfully, a second message is dispatched, mentioning the individual who created the Tag.
 ...
 ![Both Mattermost notifications on new Release](uploads/77a5eb2b-e9fd-4c1d-b5fe-150a0a651212/88ad69ec-6034-454e-8aa5-a5dd64eb7fd2/image.png)
...
2. Or by emphasizing a major new feature and grouping related issues under it (see [**__Example__**](https://iguana.wiki/doc/releases-kFXKVLD9vl#h-example)).
...
:::info
There may be instances where the names of the Issues could be enhanced to facilitate smoother deployments in the future. Please do not hesitate to suggest possible improvements to the Issue authors. By doing so, we can collectively enhance the workflow.

:::

## Example

### 👎 Automated result (bad)

 ![](uploads/77a5eb2b-e9fd-4c1d-b5fe-150a0a651212/07b1cd15-330b-48a6-bf49-8215193c2ff4/image.png)

* It is difficult to discern that a major new feature (Epic) has been released.
* Issue #301 is not clearly named (lacks specificity).

### 👍 Authored Release Notes (good)

 ![](uploads/77a5eb2b-e9fd-4c1d-b5fe-150a0a651212/73563c6f-dcb0-425a-91d3-d965522edda6/image.png)

# Notes

Documentation on how to integrate new project to this flow in Slack and Mattermost: [Releases Slack & Mattermost integration](/doc/ec8f338b-6cca-49af-9b4f-c8862fce2ce8) .