...
- Prohledej `knowledgebase/esg/templates/core`
...
**Q:** Jak vyhodnotit ESG riziko nového dodavatele?
**A:** (1) Najdi relevantní dokument v KB. (2) Cituj cestu a verzi. (3) Shrň odpověď pro uživatele.

**Q:** Kde je šablona dodavatelského dotazníku?
**A:** (1) Najdi relevantní dokument v KB. (2) Cituj cestu a verzi. (3) Shrň odpověď pro uživatele.
