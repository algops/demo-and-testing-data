# Příručka CSRD a ESRS pro FY2024

> Organizace: **Meridian Pay a.s.** | Doména: **esg** | Typ: guideline | Citlivost: internal

## Kontext

Meridian Pay a.s. provozuje platební a fintech služby v regulovaném prostředí. Tato příručka vysvětluje, jak interpretovat požadavky v oblasti **Příručka CSRD a ESRS pro FY2024** a jak je promítnout do praxe domény `esg`.

## Regulační a interní rámec

- Soulad s českou a EU legislativou relevantní pro doménu esg
- Propojení na datové zdroje v **Sphera** a související systémy
...
4. **Validace** — kontrola vzorkem záznamů z Sphera.
...
Domain owner `esg` — slack:#domain-esg
