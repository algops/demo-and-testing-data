# Runbook incident response P1/P2

> Organizace: **Meridian Pay a.s.** | Doména: **it** | Typ: runbook | Citlivost: internal

## Přehled

Runbook popisuje operativní postup: **Runbook incident response P1/P2**. Používejte při incidentech, plánovaných oknech i ad-hoc eskalacích v doméně it.
