# SOP: Zpracování záloh na daň z příjmů

> Organizace: **Meridian Pay a.s.** | Doména: **tax** | Typ: sop | Citlivost: internal

## Standardní operační postup

**SOP: Zpracování záloh na daň z příjmů** — závazný postup pro zaměstnance Meridian Pay a.s. v doméně `tax`.
...
4. **Archivace** — uložte výstupy do `knowledgebase/tax/operations/archive/`.
