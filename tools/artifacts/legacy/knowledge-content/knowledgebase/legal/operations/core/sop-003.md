# SOP: Conflict check před novým mandatem

> Organizace: **Meridian Pay a.s.** | Doména: **legal** | Typ: sop | Citlivost: internal

## Standardní operační postup

**SOP: Conflict check před novým mandatem** — závazný postup pro zaměstnance Meridian Pay a.s. v doméně `legal`.
...
4. **Archivace** — uložte výstupy do `knowledgebase/legal/operations/archive/`.
