# Přehled legislativních změn Q1 2025

> Organizace: **Meridian Pay a.s.** | Doména: **legal** | Typ: guideline | Citlivost: internal

## Kontext

Meridian Pay a.s. provozuje platební a fintech služby v regulovaném prostředí. Tato příručka vysvětluje, jak interpretovat požadavky v oblasti **Přehled legislativních změn Q1 2025** a jak je promítnout do praxe domény `legal`.

## Regulační a interní rámec

- Soulad s českou a EU legislativou relevantní pro doménu legal
- Propojení na datové zdroje v **iManage** a související systémy
...
4. **Validace** — kontrola vzorkem záznamů z iManage.
...
Domain owner `legal` — slack:#domain-legal
