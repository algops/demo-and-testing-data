...
from .util import DOCS_ROOT, DOMAINS, load_json_block, slugify
...
def _load_domain_spec(domain: str) -> tuple[list[dict], list[dict]]:
    path = DOCS_ROOT / DOMAIN_PROPOZICE[domain]
...
DOMAIN_KB_TITLES: dict[str, list[dict[str, str]]] = {
    ...
    "it": [
        {"kind": "adr", "section": "engineering", "sub": "core", "title": "Bounded contexts and domain events"},
        {"kind": "runbook", "section": "operations", "sub": "core", "title": "Git Strategy — trunk-based development"},
        {"kind": "sop", "section": "operations", "sub": "core", "title": "Code review process"},
        {"kind": "policy", "section": "compliance", "sub": "core", "title": "Issue labels and workflow states"},
        {"kind": "guideline", "section": "engineering", "sub": "core", "title": "Development specifications and handover flow"},
        {"kind": "template", "section": "templates", "sub": "core", "title": "Epic specifications template"},
        {"kind": "faq", "section": "engineering", "sub": "drafts", "title": "Sprint cadence and planning rules"},
        {"kind": "runbook", "section": "operations", "sub": "archive", "title": "Release and deploy strategy"},
        {"kind": "adr", "section": "engineering", "sub": "archive", "title": "Entity Framework data access patterns"},
        {"kind": "sop", "section": "operations", "sub": "drafts", "title": "Team sync cadence"},
        {"kind": "guideline", "section": "compliance", "sub": "core", "title": "NuGet package configuration"},
        {"kind": "policy", "section": "compliance", "sub": "drafts", "title": "Credentials and secrets handling"},
    ],
    "legal": [
...
def write_all_catalogues(min_docs: dict[str, int], domains: tuple[str, ...] | None = None) -> None:
    active = domains or DOMAINS
    for domain in active:
        types, rels = _load_domain_spec(domain)
        base = DOCS_ROOT / "domains" / domain
