# Příručka GDPR pro smluvní vztahy

> Organizace: **Meridian Pay a.s.** | Doména: **legal** | Typ: guideline | Citlivost: internal

## Kontext

Meridian Pay a.s. provozuje platební a fintech služby v regulovaném prostředí. Tato příručka vysvětluje, jak interpretovat požadavky v oblasti **Příručka GDPR pro smluvní vztahy** a jak je promítnout do praxe domény `legal`.
