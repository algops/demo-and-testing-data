# Runbook sběru emisních dat Scope 1–3

> Organizace: **Meridian Pay a.s.** | Doména: **esg** | Typ: runbook | Citlivost: internal

## Přehled

Runbook popisuje operativní postup: **Runbook sběru emisních dat Scope 1–3**. Používejte při incidentech, plánovaných oknech i ad-hoc eskalacích v doméně esg.
