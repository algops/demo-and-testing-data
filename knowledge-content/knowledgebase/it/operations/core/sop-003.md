# SOP: Code review a merge do main

> Organizace: **Meridian Pay a.s.** | Doména: **it** | Typ: sop | Citlivost: internal

## Standardní operační postup

**SOP: Code review a merge do main** — závazný postup pro zaměstnance Meridian Pay a.s. v doméně `it`.
...
4. **Archivace** — uložte výstupy do `knowledgebase/it/operations/archive/`.
