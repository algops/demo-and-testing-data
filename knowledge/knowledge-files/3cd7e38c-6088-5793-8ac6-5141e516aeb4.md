# Development specifications and handover flow

> Typ: guideline | Doména: it | Citlivost: internal
...
2. Every Issue is a separate Feature branch.
3. Each Feature branch is **tested and released separately**.
4. Frontend features are hidden with Feature flags if necessary.
