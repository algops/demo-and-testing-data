# Metodika účtování leasingu dle ČÚS

> Organizace: **Meridian Pay a.s.** | Doména: **tax** | Typ: guideline | Citlivost: internal

## Kontext

Meridian Pay a.s. provozuje platební a fintech služby v regulovaném prostředí. Tato příručka vysvětluje, jak interpretovat požadavky v oblasti **Metodika účtování leasingu dle ČÚS** a jak je promítnout do praxe domény `tax`.

## Regulační a interní rámec

- Soulad s českou a EU legislativou relevantní pro doménu tax
- Propojení na datové zdroje v **Pohoda** a související systémy
...
4. **Validace** — kontrola vzorkem záznamů z Pohoda.
...
Domain owner `tax` — slack:#domain-tax
