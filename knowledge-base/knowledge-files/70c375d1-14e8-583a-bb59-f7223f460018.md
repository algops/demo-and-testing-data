# SOP: Double materiality assessment

> Organizace: **Meridian Pay a.s.** | Doména: **esg** | Typ: sop | Citlivost: internal

## Standardní operační postup

**SOP: Double materiality assessment** — závazný postup pro zaměstnance Meridian Pay a.s. v doméně `esg`.
...
4. **Archivace** — uložte výstupy do `knowledgebase/esg/operations/archive/`.
