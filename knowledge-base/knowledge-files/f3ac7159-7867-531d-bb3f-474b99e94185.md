# Runbook: Redakce citlivých údajů ve spisech

> Organizace: **Meridian Pay a.s.** | Doména: **legal** | Typ: runbook | Citlivost: internal

## Přehled

Runbook popisuje operativní postup: **Runbook: Redakce citlivých údajů ve spisech**. Používejte při incidentech, plánovaných oknech i ad-hoc eskalacích v doméně legal.
