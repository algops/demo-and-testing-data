# Runbook: CSDDD due diligence dodavatelů

> Organizace: **Meridian Pay a.s.** | Doména: **esg** | Typ: runbook | Citlivost: internal

## Přehled

Runbook popisuje operativní postup: **Runbook: CSDDD due diligence dodavatelů**. Používejte při incidentech, plánovaných oknech i ad-hoc eskalacích v doméně esg.

## Předpoklady

- Přístup do **Sphera** a souvisejících systémů
- Role: operátor L2+ nebo on-call engineer
- Aktuální kontakty v PagerDuty / Slack `#oncall-esg`
...
- Zkontrolujte logy a poslední deploye v integraci Sphera.
