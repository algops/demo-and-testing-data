# Runbook: Kontrola od finanční správy

> Organizace: **Meridian Pay a.s.** | Doména: **tax** | Typ: runbook | Citlivost: internal

## Přehled

Runbook popisuje operativní postup: **Runbook: Kontrola od finanční správy**. Používejte při incidentech, plánovaných oknech i ad-hoc eskalacích v doméně tax.
